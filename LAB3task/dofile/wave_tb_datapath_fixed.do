...
add wave -noupdate -radix decimal /tbdatapath/counter_out
add wave -noupdate -radix decimal /tbdatapath/reg_b_out
add wave -noupdate -radix decimal /tbdatapath/reg_c_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {189117 ps} 0}
